...
export interface ICameraPanTiltProps {
  defaultValue?: string;
}
const CameraPanTiltComponent = ({ defaultValue }: ICameraPanTiltProps) => {
...
export const CameraPanTilt = memo(CameraPanTiltComponent);
